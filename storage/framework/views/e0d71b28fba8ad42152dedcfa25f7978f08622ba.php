...
<?php if(config('adminlte.usermenu_profile_url', false)): ?>
    <?php ( $profile_url = Auth::user()->profile_url ); ?>
<?php endif; ?>
...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <?php if(config('adminlte.usermenu_image')): ?>
            <img src="<?php echo e(Auth::user()->profile_url); ?>"
                 class="user-image img-circle elevation-2"
                 alt="<?php echo e(Auth::user()->nickname); ?>">
        <?php endif; ?>
...
<?php /**PATH /var/www/plugins/resources/views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>