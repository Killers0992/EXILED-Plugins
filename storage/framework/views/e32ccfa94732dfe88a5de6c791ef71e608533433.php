<nav class="main-header navbar
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <?php if(Auth::user()): ?>
            ...
            <?php endif; ?>
        <?php else: ?>
            <?php echo $__env->make('adminlte::partials.navbar.menu-item-login-link', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php /**PATH /var/www/plugins/resources/views/vendor/adminlte/partials/navbar/navbar.blade.php ENDPATH**/ ?>