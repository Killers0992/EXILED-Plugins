...
<?php $__env->startSection('title', 'EXILED Plugins | My Plugins'); ?>
        ...
        <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="<?php echo e(route('plugin.list')); ?>" method="GET">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/plugins/resources/views/myplugins.blade.php ENDPATH**/ ?>